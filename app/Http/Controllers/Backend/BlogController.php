...
class BlogController extends Controller
{
    ...
    return view('backend.blog.category.category_view',compact('blogcategory','testominals'));
}
...
public function AddBlogPost(){
    ...
    $blogcategory = BlogPostCategory::latest()->get();
     ...
     $testominals = Testominal::orderBy('testominal_name','ASC')->get();
  	...
  	return view('backend.blog.post.post_view',compact('blogpost','blogcategory','testominals'));
